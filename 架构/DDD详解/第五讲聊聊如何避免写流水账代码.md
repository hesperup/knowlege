...
[DDD系列第一讲](https://link.juejin.cn?target=https%3A%2F%2Fmp.weixin.qq.com%2Fs%3F__biz%3DMzAxNDEwNjk5OQ%3D%3D%26mid%3D2650403892%26idx%3D1%26sn%3Da91fa477392e80f9420a8ca4d26bcace%26chksm%3D83953c2cb4e2b53a6af3b5a82c3b7d7ed932bfe83f59877a935445ae89edd0ff4ee1c4e82fba%26scene%3D21%23wechat_redirect)

[DDD系列第二讲](https://link.juejin.cn?target=https%3A%2F%2Fmp.weixin.qq.com%2Fs%3F__biz%3DMzAxNDEwNjk5OQ%3D%3D%26mid%3D2650404060%26idx%3D1%26sn%3Dcacf40d19528f6c2d9fd165151d6e8b4%26chksm%3D83953cc4b4e2b5d2bd4426e0d2103f2e95715b682f3b7ff333dbb123eaa79d3e5ad24f64beac%26scene%3D21%23wechat_redirect)

[DDD系列第三讲](https://link.juejin.cn?target=https%3A%2F%2Fmp.weixin.qq.com%2Fs%3F__biz%3DMzAxNDEwNjk5OQ%3D%3D%26mid%3D2650406692%26idx%3D1%26sn%3D4a4ac4168299d8ca1905a4f457ae4c59%26chksm%3D8395373cb4e2be2a2d066a5ea4e631fd6270e969ce61883b488f61c1ce33fbc0b362ec9cbf7b%26scene%3D21%23wechat_redirect)

[DDD系列第四讲](https://link.juejin.cn?target=https%3A%2F%2Fmp.weixin.qq.com%2Fs%3F__biz%3DMzAxNDEwNjk5OQ%3D%3D%26mid%3D2650414919%26idx%3D1%26sn%3D0ad1df1a1b0e2488f7faa21008fdbdd0%26chksm%3D8396d75fb4e15e49341b07022780dcb8dca66a0efb7f129d4de86a5ef5d8a890f6e0d2fd6432%26scene%3D21%23wechat_redirect)
...
![image.png](https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/0f88059d726e4c76bb65e2553277ed02~tplv-k3u1fbpfcp-watermark.awebp)
...
这些的方法都有一个共同的点就是都有自己的网络协议，而如果我们的业务代码和网络协议混杂在一起，则会直接导致代码跟网络协议绑定，无法被复用。 所以，在DDD的分层架构中，我们单独会抽取出来Interface接口层，作为所有对外的门户，将网络协议和业务逻辑解耦。
...
在我见过的一些代码里，接口的返回值比较多样化，有些直接返回DTO甚至DO，另一些返回Result。 接口层的核心价值是对外，所以如果只是返回DTO或DO会不可避免的面临异常和错误栈泄漏到使用方的情况，包括错误栈被序列化反序列化的消耗。所以，这里提出一个规范：
...
![image.png](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/4c77feae3f06411c929d201119cdaefe~tplv-k3u1fbpfcp-watermark.awebp)
...
![image.png](https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/b301c12ea70648d3b6db089e32f026d8~tplv-k3u1fbpfcp-watermark.awebp)
...
通常有分支逻辑的，都代表一些业务判断，应该将逻辑封装到DomainService或者Entity里。但这不代表完全不能有if逻辑，比如，在这段代码里： boolean withholdSuccess = inventoryService.withhold(cmd.getItemId(), cmd.getQuantity()); if (!withholdSuccess) { throw new IllegalArgumentException("Inventory not enough"); } 虽然CC > 1，但是仅仅代表了中断条件，具体的业务逻辑处理并没有受影响。可以把它看作为Precondition。
...
![image.png](https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/e90bef71e0614ea09bf3bb7f6e786f17~tplv-k3u1fbpfcp-watermark.awebp)
...
![image.png](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/ac65ccd537d142e49ecce3bd19fb031f~tplv-k3u1fbpfcp-watermark.awebp)

有防腐层的情况：

![image.png](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/0d770f5ae33f4a34856786f1101ed655~tplv-k3u1fbpfcp-watermark.awebp)
...
![image.png](https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/7fe247fdf05d4f1abf439968b339f38f~tplv-k3u1fbpfcp-watermark.awebp)
...
![image.png](https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/bc800ed042d6429bb587c3ff7d7d9ccd~tplv-k3u1fbpfcp-watermark.awebp)
...
![image.png](https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/0dde334ee210456aafd3aeec02080ee6~tplv-k3u1fbpfcp-watermark.awebp)

在代码中的依赖是比较明确的：如果你是下游，上游对你无感知，则只能走事件驱动；如果上游必须要对你有感知，则可以走指令驱动。反过来，如果你是上游，需要对下游强依赖，则是指令驱动；如果下游是谁无所谓，则可以走事件驱动。

1. 找出业务中的“负责人”：

![image.png](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/1e2f82ab680a414dbcba712e3a6d01eb~tplv-k3u1fbpfcp-watermark.awebp)

第二种方法是根据业务场景找出其中的“负责人”。比如，如果业务需要通知卖家，下单系统的单一职责不应该为消息通知负责，但订单管理系统需要根据订单状态的推进主动触发消息，所以是这个功能的负责人。 在一个复杂业务流程里，通常两个模式都要有，但也很容易设计错误。如果出现依赖关系很奇怪，或者代码里调用链路/负责人梳理不清楚的情况，可以尝试转换一下模式，可能会好很多。
...
作者：阿里巴巴淘系技术
链接：https://juejin.cn/post/6953141151931039758
来源：掘金
